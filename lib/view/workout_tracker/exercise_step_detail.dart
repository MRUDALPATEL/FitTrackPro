...
class ExerciseStepDetails extends StatefulWidget {
  final Map eObj;
  const ExerciseStepDetails({super.key, required this.eObj});

  @override
  State<ExerciseStepDetails> createState() => _ExercisesStepDetailsState();
}

class _ExercisesStepDetailsState extends State<ExerciseStepDetails> {
  List stepArr = [
    {
      "no": "01",
